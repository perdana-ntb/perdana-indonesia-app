...
class PracticeContainer(TimeStampedModel):
    member = models.ForeignKey('member.BaseMember', on_delete=models.SET_NULL,
    ...
    signed_by = models.ForeignKey('member.BaseMember', on_delete=models.SET_NULL,
...
class PracticeSeries(TimeStampedModel):
    ...
    practice_container = models.ForeignKey(PracticeContainer, on_delete=models.CASCADE,
                                           related_name='practice_series')
