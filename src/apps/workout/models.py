...
class WorkOutTarget(TimeStampedModel):
    item = models.ForeignKey(WorkOutItem, related_name='wo_targets',
                             on_delete=models.SET_NULL, null=True)
    member = models.ForeignKey(BaseMember, related_name='wo_targets',
                               on_delete=models.SET_NULL, null=True)
...
class WorkOut(TimeStampedModel):
    item = models.ForeignKey(WorkOutItem, related_name='workouts',
                             on_delete=models.SET_NULL, null=True)
    member = models.ForeignKey(BaseMember, related_name='workouts',
                               on_delete=models.SET_NULL, null=True)
    target = models.ForeignKey(WorkOutTarget, related_name='workouts',
                               on_delete=models.SET_NULL, null=True)
