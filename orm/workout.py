...
class WorkOutTarget(TimeStampedModel):
    ...
    member = models.ForeignKey(member_models.Member, related_name='wo_targets', on_delete=models.SET_NULL, null=True)
...
class WorkOut(TimeStampedModel):
    ...
    member = models.ForeignKey(member_models.Member, related_name='workouts', on_delete=models.SET_NULL, null=True)
